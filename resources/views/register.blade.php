            ...
            <div class="p-6 lg:w-1/2 xl:w-5/12 sm:p-12">
                ...
                <form method="POST" action="{{ route('register.process') }}">
                    ...
                    <input name="email" required
                        class="w-full px-4 py-3 mb-3 bg-gray-100 border border-gray-300 rounded-lg" type="email"
                    ...
                    <div id="spesialisasiField" class="hidden">
                        <label class="block mb-1 text-sm font-semibold text-gray-700">Specialization (for doctors
                            only)</label>
